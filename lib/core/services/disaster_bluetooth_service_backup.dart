...
/// Enhanced Bluetooth service using flutter_blue_plus for disaster relief communication
/// Implements robust messaging with automatic reconnection and message queuing
class DisasterBluetoothService extends ChangeNotifier {
  ...
  // Standard SPP UUID for RFCOMM-like communication
  ...
  /// Initialize the Bluetooth service with flutter_blue_plus
  Future<bool> initialize() async {
    try {
      debugPrint('🔧 Initializing Bluetooth service with flutter_blue_plus...');
