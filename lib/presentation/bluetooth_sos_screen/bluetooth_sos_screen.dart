...
import '../../core/services/bluetooth_compatibility.dart';
import '../../core/services/disaster_bluetooth_service_windows.dart';
...
class _BluetoothSosScreenState extends State<BluetoothSosScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    // Platform check for Bluetooth support
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2.h),
                Text(
                  'Bluetooth Serial communication is not supported on ${BluetoothCompatibility.platformName}.',
                  style: TextStyle(
                    fontSize: 16.sp,
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 2.h),
                      Text(
                        '• Use the Interactive Map for location sharing\n'
                        '• Access Emergency Response features\n'
                        '• Report incidents through the main dashboard\n'
                        '• Use Voice Assistant for emergency calls',
                        style: TextStyle(
                          fontSize: 14.sp,
